...
void vp_calc(int rows, int cols, int **mat)
{
    ...
    for(int i=0; i<rows-1; i++)
    {
       ...
       {
            dis= sqrt(pow((mat[j][1]-mat[i][1]),2) + pow((mat[j][0]-mat[i][0]),2));
            idis=(int)(dis*100);
            dis=(float)idis/100;
            if(dis<45)
            {
                ad=sqrt(pow((mat[i][2]-mat[j][2]),2));
...
{
    //int **matrix2;
    float rden,ratiodiff,rmatchscore,bestrmatchscore,countcm,thescore=0;
    float aden,angdiff,amatchscore,bestamatchscore,countcm1=0;
    int bestmatch,bestmatch1,lim,lim1,i,j,nonmatratios,nonmatratios1,intsco=0;
      ...
      while(ptr5!=NULL)
        {
            ...
            for(i=0;i<ptr2->numofneigh;i++)
            {
                ...
                {
                    ratiodiff=(pow((ptr2->dismat[i]-ptr5->dismat[j]),2));
                    angdiff=(pow((ptr2->angmat[i]-ptr5->angmat[j]),2));
        ...
        for(i=0;i<rows;i++)
            {
               ...
               for(j=0;j<rows1;j++)
               {
                    xd= sqrt(pow((mat1[j][0]-x),2));
                    yd= sqrt(pow((mat1[j][1]-y),2));
                    ad= sqrt(pow((mat1[j][2]-z),2));
                    admin=360-ad;
                    if (admin>ad)
                        admin=ad;
...
/*
char file0[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_01.fmr";
char file1[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_02.fmr";
char file2[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_03.fmr";
char file3[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_04.fmr";
char file4[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_05.fmr";
char file5[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_06.fmr";
char file6[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_07.fmr";
char file7[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_08.fmr";
char file8[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_09.fmr";
char file9[500]="C:\\Documents and Settings\\shaziaa\\My Documents\\Downloads\\arun\\gg\\FMR\\P01_F02_10.fmr";
...
int main()
{
 ...
 DIR *dir;
	...
	if (dir != NULL)
	{
		...
		{   //printf("\nblah");
			strcpy(fileName[fileCount],ent->d_name);
			strcpy(fileName1[fileCount],ent->d_name);
			fileCount++;
        }
